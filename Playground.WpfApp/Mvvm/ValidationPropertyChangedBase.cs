        ...
        public IEnumerable<ValidationResult> AllErrors
        {
            get
            {
                ...
                if (_errors.Count > 0)
                {
                    ...
                    {
                        if (propertyName.Value.Count > 0)
                        {
                            foreach (var item in propertyName.Value)
                            {
                                vResults.Add(new ValidationResult(item));
                            }
                        }
                        else
                        {
                            vResults.Add(new ValidationResult(propertyName.Value[0]));
                        }
                    }
                    return vResults;
                }
