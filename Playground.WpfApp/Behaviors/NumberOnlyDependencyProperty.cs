...
{
    public static class NumberOnlyDependencyProperty
    {
        public static readonly DependencyProperty IsEnabledProperty =
                DependencyProperty.RegisterAttached("IsEnabled", typeof(bool),
                typeof(NumberOnlyDependencyProperty), new UIPropertyMetadata(false, OnValueChanged));
    ...
    /*
  Usage:
        xmlns:numberOnlyDPWpf="clr-namespace:Seraph.WpfPlayground.DependencyProperties"
        <TextBox numberOnlyDPWpf:NumberOnlyDependencyProperty.IsEnabled="True" TextAlignment="Left"/>
 */
}
